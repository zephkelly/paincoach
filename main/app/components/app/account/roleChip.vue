<template>
    <span class="chip" :class="{ admin: userRole === 'admin', clinician: userRole === 'clinician', patient: userRole === 'patient' }">
        
        <TransitionGroup name="fade" tag="div" class="transition-wrapper">
            
            <template v-if="userRole === undefined || userRole === null">
                <div class="loading-skeleton skeleton-component skeleton-component-panel skeleton-component-border">
