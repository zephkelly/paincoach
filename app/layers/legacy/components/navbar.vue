    ...
    <nav class="navbar footer">
        <div class="container">
            ...
            <!-- <div class="collapse navbar-collapse" id="navbarNav"> -->
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <NuxtLink to="/" class="nav-link overview" :class="{ active: isOverviewActive }">
                    ...
                    <li class="nav-item">
                        <NuxtLink to="/calendar" class="nav-link" :class="{ active: isCalendarActive }">
                    ...
                    <li class="nav-item">
                        <NuxtLink to="/insights" class="nav-link" :class="{ active: isInsightsActive }">
                    ...
                    <li class="nav-item">
                        <NuxtLink to="/settings" class="nav-link" :class="{ active: isSettingsActive }">
                    ...
                    <li class="nav-item dashboard" v-if="hasRole('admin')">
                        <NuxtLink :to="config.public.dashboardUrl" class="nav-link">
                            <svg class="dashboard" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><!-- Icon from Lucide by Lucide Contributors - https://github.com/lucide-icons/lucide/blob/main/LICENSE --><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/></g></svg>
                        </NuxtLink>
                    </li>
                </ul>
            <!-- </div> -->
...
const isOverviewActive = computed(() => route.path === '/');
const isCalendarActive = computed(() => route.path === '/calendar');
const isInsightsActive = computed(() => route.path === '/insights');
...
nav.navbar.footer svg {
    ...
    transition:
        fill 0.35s cubic-bezier(0.075, 0.82, 0.165, 1),
