...
export const DBEncryptedPatientMedicationDataV1PartialSchema = DBEncryptedPatientMedicationDataV1Schema.partial();

export const DBEncryptedPatientMedicationV1Schema = z.object({
    version: z.literal(1),
    data: DBEncryptedPatientMedicationDataV1Schema,
}).strict();